...
def create_argparser():
    ...
    parser.add_argument('--mta_encoding', choices=(MTATask.MTAEncodingType.full, MTATask.MTAEncodingType.compact),
...
if __name__ == '__main__':
    ...
    for i in range(args.continue_training_from_train_step + 1, args.num_train_steps):
        ...
        if args.task == MTATask.name:
            generator_args['cli_mode'] = args.mta_encoding == MTATask.MTAEncodingType.full
            generator_args['numbers_quantity'] = args.num_experts
